#!/usr/bin/env python3
"""
Applique les traductions finales sur les 11 sous-dossiers langue de ai-soulgen.com
"""
...
for lang in langs:
    ...
    dict_path = f'/root/ai-soulgen.com/trans_{lang}_final.json'
    ...
    # Sauvegarder
    output_path = f'/root/ai-soulgen.com/{lang}/index.html'
